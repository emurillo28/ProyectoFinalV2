...
public class GraphActivity extends Activity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        aerobicas = db.lstActividadesAERO(); //De aqui obtenemos el listado de la base de datos.
        ...
        float i = (float)3.1416;
        for (Aerobica aerobica : aerobicas) {
